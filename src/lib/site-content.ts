...
export const CONTENT_FIELDS: ContentField[] = [
  ...
  { key: "form.file.label", section: "Contact form", label: "Attachment — label", value: "Attach a file" },
  { key: "form.file.button", section: "Contact form", label: "Attachment — button", value: "Choose file" },
  { key: "form.file.hint", section: "Contact form", label: "Attachment — hint", value: "PDF, image or document · up to 5 MB" },
